//Filtrar y ordenar paquetes de datos
...
const paquetesFiltradosOrdenados = paquetesDatos
    .filter(p => p.tamaño > 1000)               // Filtra tamaño mayor a 1000
    .sort((a, b) => b.prioridad - a.prioridad); // Ordena por prioridad descendente
    
    
console.log("Paquetes filtrados y ordenados:");
